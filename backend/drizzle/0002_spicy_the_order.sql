...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "pages" ADD CONSTRAINT "pages_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "blocks_page_position_idx" ON "blocks" USING btree ("page_id","position");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pages_workspace_parent_idx" ON "pages" USING btree ("workspace_id","parent_page_id","position");--> statement-breakpoint
