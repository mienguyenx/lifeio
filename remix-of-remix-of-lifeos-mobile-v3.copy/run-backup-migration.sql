...
DROP POLICY IF EXISTS "Users can create own backups" ON public.backup_history;
DROP POLICY IF EXISTS "Users can update own backups" ON public.backup_history;
DROP POLICY IF EXISTS "Admins can view all backups" ON public.backup_history;
DROP POLICY IF EXISTS "Admins can manage all backups" ON public.backup_history;
DROP POLICY IF EXISTS "Users can view own backup progress" ON public.backup_progress;
DROP POLICY IF EXISTS "Users can create own backup progress" ON public.backup_progress;
DROP POLICY IF EXISTS "Admins can view all backup progress" ON public.backup_progress;
DROP POLICY IF EXISTS "Admins can manage all backup progress" ON public.backup_progress;
DROP POLICY IF EXISTS "Admins can manage backup settings" ON public.backup_settings;
DROP POLICY IF EXISTS "Everyone can view backup settings" ON public.backup_settings;
...
DROP TRIGGER IF EXISTS backup_history_updated_at ON public.backup_history;
...
DROP TRIGGER IF EXISTS backup_settings_updated_at ON public.backup_settings;
