-- =====================================================
-- FIX VIETNAMESE ENCODING IN AI PROMPTS (V2 - UTF-8)
-- =====================================================
-- Script này sửa lại các prompts với encoding UTF-8 đúng
-- Sử dụng SET client_encoding để đảm bảo encoding đúng
...
-- Reset client encoding (optional)
