...
// Inline types for mobile - avoiding cross-module imports
interface HealthLog { id: string; date: string; type: string; value: number; unit: string; userId?: string; }
interface FinanceTransaction { id: string; date: string; type: 'income' | 'expense'; category: string; amount: number; description?: string; userId?: string; }
interface Course { id: string; title: string; platform?: string; status: string; progress?: number; userId?: string; }
interface Book { id: string; title: string; author?: string; status: string; userId?: string; }
interface Contact { id: string; name: string; type: string; email?: string; phone?: string; userId?: string; }
interface Interaction { id: string; contactId: string; type: string; date: string; notes?: string; userId?: string; }
